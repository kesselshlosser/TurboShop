...
This template is responsible for the general appearance of pages without a central block.
*}
...
<head>
	...
	{elseif $smarty.get.sort || !$set_canonical || !$self_canonical}
		<link rel="canonical" href="{$filter_canonical}">
	{/if}
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-4">
				<figure class="box item-logo">
					...
					{else}
						<a href="{$lang_link}brands/{$b->url}"><h3>{$b->name|escape}</h3></a>
					{/if}
				</figure> <!-- item-logo.// -->
			</div> <!-- col.// -->
			{/if}
