                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="es-p10t es-p0b es-p30r es-p30l" align="center">
                                              <p>{$lang->email_comment_hello} <i>{$order->name|escape}</i>. {$lang->email_order_order_message} <strong>№{$order->id}</strong> {$lang->email_order_text_of} <strong>{$order->date|date}:{$order->date|time}.</strong> {$lang->email_order_text_status}</p>
                                              <span class="es-status-color">{if $order->status == 0}{$lang->waiting_for_processing}{elseif $order->status == 1}{$lang->in_processing}{elseif $order->status == 2}{$lang->completed}{elseif $order->status == 3}{$lang->canceled}{/if}</span>
                                            </td>
                                          </tr>
                                          <tr>
                                  ...
                                  <tr>
                                    <td class="es-m-p20b" width="100%" align="left">
                                      <table class="es-table-infobox" cellspacing="1" cellpadding="1" border="0" align="left">
                                        <tbody>
                                          <tr valign="top">
                                            <td class="es-p5t es-p5b" width="180px"><span>{$lang->email_order_number_s}:</span></td>
                                          ...
                                          <tr valign="top">
                                            ...
                                            <td class="es-p5t es-p5b"><span>{if $order->status == 0}{$lang->waiting_for_processing}{elseif $order->status == 1}{$lang->in_processing}{elseif $order->status == 2}{$lang->completed}{elseif $order->status == 3}{$lang->canceled}{/if}</span></td>
                                          </tr>
                                          <tr valign="top">
                                                    ...
                                                    <td width="100%" align="left">
                                                      <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                          <tr>
                                                            <td>
                                                              <a href="{$config->root_url}/products/{$purchase->product->url}" style="font-family: 'Trebuchet MS';font-size: 16px;color: #222;text-decoration: none;line-height: normal;">{$purchase->product_name|escape}</a><br />
                                                      ...
                                                      <table style="width: 500px;" cellspacing="1" cellpadding="1" border="0" align="right">
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td style="text-align: right; font-size: 18px; line-height: 150%; color: #000;">{$order->weight} {$settings->weight_units}</td>
                                                          </tr>
                                                          {/if}
