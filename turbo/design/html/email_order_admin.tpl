																	...
																	<td align="left">
																		<table style="width: 100%;" cellspacing="1" cellpadding="1" border="0">
																			<tbody>
																				<tr>
																					<td>
																						<a href="products/{$purchase->product->url}" style="font-family: 'Trebuchet MS';font-size: 16px;color: #222;text-decoration: none;line-height: normal;">{$purchase->product_name|escape}</a><br />
																						...
																						<div class="es-p5t" style="color: #000; font-size: 12px;font-weight: 600">{$btr->product_pre_order}</div>
																						{/if}
