                        ...
                        {if $filename}
                            ...
                            <div class="turbo_list">
                                <div class="turbo_list_head">
                                    <div class="col-lg-6 col-md-6"><b>{$btr->import_csv_columns}</b></div>
                                ...
                                <div class="turbo_list_footer">
                                    <div class="col-lg-12 col-md-12">
                                        <button type="submit" name="import" value="1" class="btn btn_small btn_green float-md-right"><i class="fa fa-upload"></i>&nbsp;{$btr->import_do_import}</button>
                                    </div>
                                </div>
                            </div>
                        {elseif $import}
