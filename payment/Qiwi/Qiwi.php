...
{	
	public function checkout_form($order_id, $button_text = null)
	{
		...
		$message = "Номер мобильного телефона:";
		...
		$button =	"<form action='https://w.qiwi.com/order/external/create.action'>".
					...
					"<div class='form-group'><label>$message</label><span class='input-group'><input type=text class='form-control mr-sm-2' name=to value='".$phone."'><input type=submit class='btn btn-success' value='$button_text'></span></div>".
					"</form>";
		return $button;
	}
