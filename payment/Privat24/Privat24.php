...
class Privat24 extends Turbo
{
	public function checkout_form($order_id, $button_text = null)
	{
        ...
        $button =   '<form class="checkout-form" action="https://api.privatbank.ua/p24api/ishop" method="POST"/>'.
                    ...
                    '<input class="button btn btn-success" type="submit" value="' . $button_text . '" />'.
                    '</div>'.
                    '</form>';
