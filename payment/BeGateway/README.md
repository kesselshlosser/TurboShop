# Модуль оплаты beGateway для CMS Turbo

## Установка

  * [Скачайте архив модуля](https://github.com/beGateway/turbo-payment-module/raw/master/turbo-payment-module.zip), распакуйте его и скопируйте его содержимое в корневую директорию вашей Turbo инсталляции.
