...
class YandexMoneyApi extends Turbo
{
    ...
    public function getApiClient($shopId, $shopPassword, $logger)
    {
        ...
        $userAgent->setCms('Turbo', $this->config->version);
        $userAgent->setModule('yandexmoney-turbocms', YAMONEY_MODULE_VERSION);
